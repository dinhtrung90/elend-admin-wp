                  ...
                  <td>
                    <CDropdown className="m-1 d-inline-block custom-dropdowns">
                      ...
                      <CDropdownMenu placement="left">
                        <CDropdownItem onClick={() => handleToEdit(item)}>
                          {t('common.Edit')}
                        </CDropdownItem>
                        <CDropdownItem onClick={() => handleResendVerifyEmail(item.id)}>
                          {t('common.ResendVerifyEmail')}
                        </CDropdownItem>
                        <CDropdownItem onClick={() => handleResetPasswordEmail(item.id)}>
                    ...
                    {/*</CButton>*/}
                    {/*<CButton color="danger" className="me-1"><CIcon name="cil-trash" /></CButton>*/}
                  </td>
                ),
              }}
            />
