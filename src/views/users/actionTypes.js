...
export const USERS_GET_ADDRESS_BY_ID_REQUEST = 'USERS_GET_ADDRESS_BY_ID_REQUEST';
export const USERS_GET_ADDRESS_BY_ID_SUCCESS = 'USERS_GET_ADDRESS_BY_ID_SUCCESS';
export const USERS_GET_ADDRESS_BY_ID_FAILURE = 'USERS_GET_ADDRESS_BY_ID_FAILURE';
