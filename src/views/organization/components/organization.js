...
import {
  ...
  CCol,
  CRow,
  CButton, CLabel, CInput, CFormGroup, CNavItem, CNavLink, CNav, CTabs, CTabContent, CTabPane
} from '@coreui/react';
...
const Organization = () => {
  ...
  const organizeText = {
    ...
    LogoDesc: 'If set, this is the logo that will be displayed to end-users for this organization in any interaction with them.',
                    ...
                    <CRow className="mt-4">
                      ...
                      <CCol sm="12">
                        <CFormGroup>
                          ...
                          <CInput id="name" placeholder={organizeText.NamePlaceholder} disabled />
                      ...
                      <CCol sm={12}>
                        <CLabel className="font-weight-bold">{organizeText.Logo}</CLabel>
                      </CCol>
                      <CCol sm={12}>
                        <CLabel htmlFor="primaryColor" className="font-weight-bold">{organizeText.PrimaryColor}</CLabel>
                        <div className={focusInputColorText ? "color-picker-container color-picker-container-focus" : "color-picker-container"}>
                          <input id="primaryColorPicker" type="color" className="input-color-picker no-outline"/>
                          <input id="primaryColor" className="input-color-text no-outline"
                                 onBlur={() => setFocusInputColorText(focusInputColorText => !focusInputColorText) }
                                 onFocus={() => setFocusInputColorText(focusInputColorText => !focusInputColorText) }/>
                        </div>
                      </CCol>
